...
import org.chx.kdroid.candy.rx.EmptyObserver
import org.chx.kdroid.candy.rx.observeOnMainThread
import java.util.*
...
abstract class DataRefresher<D> {
    ...
    fun loadMore() {
        observeAt(pageIndex).observeOnMainThread(object : EmptyObserver<List<D>>() {
