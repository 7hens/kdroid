...
interface Reflect<T> {
    ...
    companion object {
        fun <T> of(cls: Class<T>): Reflect<T> {
            return ReflectImpl(cls, null)
        }

        fun of(className: String): Reflect<*> {
        ...
        private val nil: Reflect<*> by lazy {
            of(Reflect::class.java).proxy { _, method, args ->
    ...
    private class ReflectImpl<T>(val cls: Class<T>, val obj: T?) : Reflect<T> {
